...
public final class KeyGenerator {
    ...
    /**
     * @return key, 22 length string, [0-9A-Za-z\-\_]
     */
    public static String getNew() {
        return generateKey((byte) 1);
    }

    public static boolean validate(String key) {
        return key != null && key.length() == 22;
    }

    /**
     * @param spec must be 0x0-0xF
     * @return key string
     */
    private static String generateKey(byte spec) {
