...
public class StaffDao extends AbstractDao<Staff, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property StaffNumber = new Property(1, String.class, "staffNumber", false, "STAFF_NUMBER");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"STAFF\" (" + //
                ...
                "\"STAFF_NUMBER\" TEXT," + // 1: staffNumber
                "\"NAME\" TEXT);"); // 2: name
    }
    ...
    public Staff readEntity(Cursor cursor, int offset) {
        Staff entity = new Staff( //
            ...
            cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1), // staffNumber
    ...
    public void readEntity(Cursor cursor, Staff entity, int offset) {
        ...
        entity.setStaffNumber(cursor.isNull(offset + 1) ? null : cursor.getString(offset + 1));
