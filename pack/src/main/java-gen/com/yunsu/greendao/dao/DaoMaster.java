...
public class DaoMaster extends AbstractDaoMaster {
    ...
    public static void createAllTables(SQLiteDatabase db, boolean ifNotExists) {
        PackDao.createTable(db, ifNotExists);
        ProductDao.createTable(db, ifNotExists);
        StaffDao.createTable(db, ifNotExists);
        ProductBaseDao.createTable(db, ifNotExists);
        PatternInfoDao.createTable(db, ifNotExists);
    }
    
    /** Drops underlying database table using DAOs. */
    public static void dropAllTables(SQLiteDatabase db, boolean ifExists) {
        PackDao.dropTable(db, ifExists);
        ProductDao.dropTable(db, ifExists);
        StaffDao.dropTable(db, ifExists);
        ProductBaseDao.dropTable(db, ifExists);
        PatternInfoDao.dropTable(db, ifExists);
    }
    ...
    public DaoMaster(SQLiteDatabase db) {
        ...
        registerDaoClass(PackDao.class);
        registerDaoClass(ProductDao.class);
        registerDaoClass(StaffDao.class);
        registerDaoClass(ProductBaseDao.class);
        registerDaoClass(PatternInfoDao.class);
    }
