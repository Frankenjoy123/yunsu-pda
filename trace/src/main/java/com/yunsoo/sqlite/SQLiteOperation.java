...
public class SQLiteOperation {
    ...
    public static void insertPathData(SQLiteDatabase db,String pack_key,int action_id,String time){
        db.execSQL("insert into path values(null,?,?,?)",new String[]{pack_key,String.valueOf(action_id),time});
    }
}
