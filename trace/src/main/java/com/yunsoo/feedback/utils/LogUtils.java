 ...
 */
package com.yunsoo.feedback.utils;
...
import com.forlong401.log.transaction.utils.*;
...
public class LogUtils {
	...
	public static File getLogDir(Context context) {
		return com.forlong401.log.transaction.utils.Utils.getAppCacheDir(context, LOG_CACHE_DIRECTORY_NAME);
	}

	public static File getCrashDir(Context context) {
		return com.forlong401.log.transaction.utils.Utils.getAppCacheDir(context, CRASH_CACHE_DIRECTORY_NAME);
	}
