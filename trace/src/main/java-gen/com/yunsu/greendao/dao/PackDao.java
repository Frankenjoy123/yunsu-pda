...
public class PackDao extends AbstractDao<Pack, Long> {
    ...
    */
    public static class Properties {
        ...
        public final static Property MaterialId = new Property(6, Long.class, "materialId", false, "MATERIAL_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"PACK\" (" + //
                ...
                "\"MATERIAL_ID\" INTEGER);"); // 6: materialId
    }
    ...
    public Pack readEntity(Cursor cursor, int offset) {
        Pack entity = new Pack( //
            ...
            cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6) // materialId
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Pack entity, int offset) {
        ...
        entity.setMaterialId(cursor.isNull(offset + 6) ? null : cursor.getLong(offset + 6));
     }
