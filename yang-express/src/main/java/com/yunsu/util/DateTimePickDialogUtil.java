...
public class DateTimePickDialogUtil {
    ...
    public AlertDialog dateTimePicKDialog(final TextView textView, final ListView listView, final TextView tv_pack_total_count, final TextView tv_product_total_count) {
        ...
        ad = new AlertDialog.Builder(activity)
                ...
                .setPositiveButton("查询", new DialogInterface.OnClickListener() {
                    public void onClick(DialogInterface dialog, int whichButton) {
                        ...
                        executeQueryReport(queryDate,activity,listView,tv_pack_total_count,tv_product_total_count);
                    }
                })
    ...
    public static void executeQueryReport(final String queryDate, final Activity activity, final ListView listView, final TextView tv_pack_total_count, final TextView tv_product_total_count){
        ...
        ServiceExecutor.getInstance().execute(new Runnable() {
            ...
            public void run() {
                ...
                final List<StaffCountEntity> staffCountEntityList = packService.queryPackProductCountByDate(queryDate);
                ...
                activity.runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        for(StaffCountEntity entity : staffCountEntityList){
                            totalPackCount+=entity.getPackCount();
                            totalProductCount+=entity.getProductCount();
                        }

                        tv_pack_total_count.setText(totalPackCount+"箱");
                        tv_product_total_count.setText(totalProductCount+"个");
                        ReportAdapter adapter=new ReportAdapter(activity);
                        adapter.setStaffCountEntityList(staffCountEntityList);
